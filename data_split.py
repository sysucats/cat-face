...
parser.add_argument("--source", default="data/crop_photos", type=str, help="photo data directory (default: data/crop_photos)")
...
for category in categories:
    ...
    for dataset_dir, dataset_images in zip([train_dir, test_dir], [train_images, test_images]):
        dataset_category_dir = os.path.join(dataset_dir, category, dataset_dir.split('/')[-1])
...
print(f"Dataset {args.name} preparation completed with image resizing and splitting into train and test sets.")