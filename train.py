...
def main():
    ...
    parser.add_argument("--data", default="data/dataset-cat", type=str, help="photo data directory (default: data/dataset-cat)")
    ...
    # print(path_to_model)
    # TODO: move model to ./export and rename to f'{args.name}.onnx'
